...
<body itemscope itemtype="http://schema.org/WebPage">
    ...
    <section class="safety-banner">
        <img class="img-fluid w-100" src="images/safety-banner.webp" alt="Annai Crackers about banner"
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-12 text-center mb-5 safety-guidelines-header">
                    ...
                    <p class="section-subtitle split-text">Essential safety protocols to ensure your fireworks
                        celebration remains joyful and secure</p>
                </div>
            </div>
            ...
            <div class="row flex-column">
                ...
                <div class="col-lg-12 col-md-12 col-12 mb-4 mb-lg-0">
                    <div class="safety-guidelines-column safety-guidelines-column-practices">
                        <div class="safety-guidelines-column-header">
                            <div class="safety-guidelines-icon-wrapper motion-path">
                                <i class="bi bi-check-circle-fill"></i>
                            </div>
                            <h3 class="safety-guidelines-column-title text-success split-text">Best Practices</h3>
                            <p class="safety-guidelines-column-subtitle split-text">Crucial guidelines for a safe
                                celebration</p>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="safety-guidelines-column safety-guidelines-column-warnings">
                        <div class="safety-guidelines-column-header">
                            <div
                                class="safety-guidelines-icon-wrapper safety-guidelines-icon-wrapper-warning motion-path">
                                <i class="bi bi-exclamation-triangle-fill"></i>
                            </div>
                            <h3 class="safety-guidelines-column-title text-danger split-text">Safety Warnings</h3>
                            <p class="safety-guidelines-column-subtitle split-text">Critical precautions to prevent
                                potential hazards</p>
                        </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="safety-guidelines-cta bg-warning">
                        <div class="row align-items-center">
                            <div class="col-lg-8 col-md-7 col-12 mb-4 mb-md-0">
                                <h4 class="split-text">Prepared for a Safe Celebration?</h4>
                                <p class="split-text">Explore our collection of certified, safety-compliant fireworks!
                                </p>
                            </div>
